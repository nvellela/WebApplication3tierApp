...
namespace _1CommonInfrastructure.Services
{
    public class LoggingService : ILoggingService
    {
        ...
        {
            var connectionString = "data source=.\\sqlexpress01;initial catalog=testdb27Sep22;integrated security=True;MultipleActiveResultSets=True;";//_configuration.GetSection("ConnectionStrings:ApplicationDB");                    
